...
type ESLintPluginRuleModule = RuleModuleWithMetaDocs<string, readonly unknown[], ESLintPluginDocs>;
...
declare namespace rules {
  export type { ESLintPluginDocs, ESLintPluginRuleModule, TypeScriptESLintRules };
}
